...
/* TPS43 controller register definitions with IQS572 - Based on IQS5xx-B000
 * datasheet */
...
// Read-write
#define TPS43_REG_SYSTEM_CONTROL_0                                             \
  0x0431 /* 1 byte - Main control (ACK_RESET, AUTO_ATI) */
...
#define TPS43_REG_SYSTEM_CONFIG_1                                              \
  0x058F /* 1 byte - Additional configuration                                  \
          */

#define TPS43_REG_GLOBAL_ATI_C 0x056B /* 1 byte - Global ATI C value */
#define TPS43_REG_ATI_TARGET 0x056D   /* 2 byte - ATI target value */
#define TPS43_REG_REF_DRIFT_LIMIT                                              \
  0x0571 /* 1 byte - ATI reference drift limit */
#define TPS43_REG_REATI_LOWER_LIMIT                                            \
  0x0573 /* 1 byte - ATI reattempt lower limit */
#define TPS43_REG_REATI_UPPER_LIMIT                                            \
  0x0574 /* 1 byte - ATI reattempt upper limit */
...
#define TPS43_REG_REPORT_RATE_ACTIVE                                           \
  0x057A /* 2 byte - Report rate active [ms]*/
#define TPS43_REG_REPORT_RATE_IDLE_TOUCH                                       \
  0x057C /* 2 byte - Report rate idle touch [ms] */
...
#define TPS43_REG_TIMEOUT_IDLE_TOUCH                                           \
  0x0585                              /* 1 byte - Timeout idle touch [s] */
#define TPS43_REG_TIMEOUT_IDLE 0x0586 /* 1 byte - Timeout idle [s] */
#define TPS43_REG_TIMEOUT_LP1 0x0587  /* 1 byte - Timeout lp1 [s] */
#define TPS43_REG_REF_UPDATE_TIME                                              \
  0x0588 /* 1 byte - Reference update time [s] */

// XY filtering settings
#define TPS43_REG_XY_STATIC_BETA                                               \
  0x0633 /* 1 byte - XY static beta (See 5.9.2.2) */
#define TPS43_REG_ALP_COUNT_BETA                                               \
  0x0634 /* 1 byte - ALP count beta (See 3.3.2) */
#define TPS43_REG_ALP1_LTA_BETA                                                \
  0x0635                               /* 1 byte - ALP1 LTA beta (See 3.4.2)   \
                                        */
#define TPS43_REG_ALP2_LTA_BETA 0x0636 /* 1 byte - ALP2 LTA beta */
#define TPS43_REG_XY_DYNAMIC_FILTER_BOTTOM                                     \
  0x0637 /* 1 byte - XY dynamic filter bottom beta (See 5.9.2.1) */
#define TPS43_REG_XY_DYNAMIC_FILTER_LOWER                                      \
  0x0638 /* 1 byte - XY dynamic filter lower speed */
#define TPS43_REG_XY_DYNAMIC_FILTER_UPPER                                      \
  0x0639 /* 2 bytes - XY dynamic filter upper speed */

#define TPS43_REG_X_RESOLUTION 0x066E /* 2 bytes - X resolution */
#define TPS43_REG_Y_RESOLUTION 0x0670 /* 2 bytes - Y resolution */

#define TPS43_DEFAULT_READ_ADDRESS                                             \
  0x0675 /* 2 bytes - default address used for reading if none is specified */
/* XY configuration */
// Read-write
...
#define TPS43_REG_SWIPE_INITIAL_TIME                                           \
  0x06BF /* 2 bytes - Swipe initial time [ms] */
#define TPS43_REG_SWIPE_INITIAL_DISTANCE                                       \
  0x06C1 /* 2 bytes - Swipe initial distance [pixels] */
#define TPS43_REG_SWIPE_CONSECUTIVE_TIME                                       \
  0x06C3 /* 2 bytes - Swipe consecutive time [ms] */
#define TPS43_REG_SWIPE_CONSECUTIVE_DISTANCE                                   \
  0x06C5 /* 2 bytes - Swipe consecutive distance [pixels] */
#define TPS43_REG_SWIPE_ANGLE 0x06C7 /* 1 byte  - Swipe angle [64tan(deg)] */
#define TPS43_REG_SCROLL_INITIAL_DISTANCE                                      \
  0x06C8 /* 2 bytes - Scroll initial distance [pixels] */
#define TPS43_REG_SCROLL_ANGLE                                                 \
  0x06CA /* 1 byte  - Scroll angle [64tan(deg)]                                \
          */
#define TPS43_REG_ZOOM_INITIAL_DISTANCE                                        \
  0x06CB /* 2 bytes - Zoom initial distance [pixels] */
#define TPS43_REG_ZOOM_CONSECUTIVE_DISTANCE                                    \
  0x06CD /* 2 bytes - Zoom consecutive distance [pixels] */
...
/* End communication window - MUST be called after each read (writing to invalid
 * address 0xEEEE causes NACK) */
...
struct tps43_config {
  ...
  bool scroll;
  bool zoom;
  bool single_finger_swipes;
  bool multi_finger_swipes;
  bool invert_x;
  bool invert_y;
  bool switch_xy;
...
struct tps43_drv_data {
  ...
  bool suspended;
  bool touching;
  int64_t last_multi_finger_swipe_ms;
};
